...
public class CodeStringUtils {
    public static String getCodeString(int code) {
        switch (code) {
            case 400:
                return UUtils.getString(R.string.llm_input_key_error_info_400);
            case 401:
            ...
            case 429:
                return UUtils.getString(R.string.llm_input_key_error_info_429);
            case 500:
                return UUtils.getString(R.string.llm_input_key_error_info_500);
            case 503:
                return UUtils.getString(R.string.llm_input_key_error_info_503);
            default:
                return UUtils.getString(R.string.llm_input_key_error_info_other);
        }
    }
}
